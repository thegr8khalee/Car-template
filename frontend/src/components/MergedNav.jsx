          ...
          >
            ...
            <div className=" flex space-x-2 justify-center items-center">
                <div className="relative hidden lg:flex" ref={profileMenuRef}>
                    <button type="button" onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)} className="h-10 w-10 btn bg-primary/10 shadow-none border-none p-2 text-primary btn-circle"><User className="size-7" /></button>
                    <AnimatePresence>
                      {isProfileMenuOpen && (
                        <>
                    ...
                    <button type="button" onClick={() => setIsMenuOpen(!isMenuOpen)} className="ml-2 h-10 w-10 btn bg-primary/10 shadow-none border-none p-2 text-primary btn-circle"><MenuIcon className="size-7" /></button>
                    <AnimatePresence>
                      {isMenuOpen && (
                        <>
                ...
                <div className="relative lg:hidden" ref={accountMenuRef}>
                    <button type="button" onClick={() => setIsAccountMenuOpen(!isAccountMenuOpen)} className="h-10 w-10 btn bg-sky shadow-none border-none p-2 text-primary btn-circle"><Menu className="size-7" /></button>
                    <AnimatePresence>
                      {isAccountMenuOpen && (
                        <>
