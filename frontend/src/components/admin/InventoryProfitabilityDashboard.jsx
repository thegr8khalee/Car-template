  ...
  if (!metrics) {
    return (
      <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
        ...
        <p className="text-gray-600 font-medium">No inventory data available</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Profitability Dashboard</h1>
            <p className="text-sm text-gray-500">Track inventory value and profits</p>
          </div>
        </div>
        <button
          onClick={loadDashboardData}
          disabled={loading}
          className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-medium text-gray-700 disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm text-gray-500">Gross Inventory Value</h2>
            <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm text-gray-500">Projected Revenue</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm text-gray-500">Realized Profit</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm text-gray-500">Potential Profit</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Average Markup */}
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <h2 className="text-sm text-gray-500 mb-3">Average Markup</h2>
        ...
        {/* Inventory Turnover */}
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <h2 className="text-sm text-gray-500 mb-3">Turnover Rate</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm text-gray-500">Est. Days to Sell</h2>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-md transition-all duration-200">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Profit by Make</h2>
        {profitByMake.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left text-sm font-medium text-gray-500 py-3 px-4">Make</th>
                  <th className="text-right text-sm font-medium text-gray-500 py-3 px-4">Total Profit</th>
                  <th className="text-right text-sm font-medium text-gray-500 py-3 px-4">Avg Profit</th>
                  <th className="text-right text-sm font-medium text-gray-500 py-3 px-4">Sold</th>
                </tr>
              </thead>
              <tbody>
                {profitByMake.slice(0, 10).map((item, idx) => (
                  <tr key={idx} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="py-3 px-4 font-medium text-gray-900">{item.make}</td>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-md transition-all duration-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="p-4 bg-amber-50 rounded-xl">
            <p className="text-xs text-gray-500 mb-1">Active (For Sale)</p>
            <p className="text-2xl font-bold text-amber-600">
          ...
          <div className="p-4 bg-primary/10 rounded-xl">
            <p className="text-xs text-gray-500 mb-1">Avg Cost per Vehicle</p>
