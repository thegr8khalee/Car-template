    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Manage subscribers and broadcasts</p>
        </div>
      </div>
...
const BroadcastCard = ({ broadcast }) => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      ...
      draft: { text: 'Draft', class: 'bg-gray-100 text-gray-600' },
    };
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-4 hover:border-gray-200 hover:shadow-md transition-all duration-200">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <h3 className="font-semibold text-gray-900 text-lg">{broadcast.subject}</h3>
