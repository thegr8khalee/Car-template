                ...
                return (
                  <div key={index}>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm font-medium text-gray-700">{item.bodyType || 'Unknown'}</span>
              ...
              {carStats.byMake.slice(0, 6).map((item, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3">
                    <span className="text-sm font-medium text-gray-700 w-24 truncate">{item.make}</span>
          ...
          {blogStats?.topPerforming?.length > 0 ? (
            <div className="space-y-3">
              {blogStats.topPerforming.slice(0, 5).map((blog, index) => (
                <div key={blog.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 bg-gray-50 rounded-xl text-center">
                  <p className="text-3xl font-bold text-gray-900">{dashboardStats.sellingToUs.total}</p>
                  <p className="text-sm text-gray-500">Total Submissions</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-xl text-center">
                  <p className="text-3xl font-bold text-gray-900">{dashboardStats.sellingToUs.thisMonth}</p>
            ...
            <div className="space-y-3">
              {blogStats.byCategory.map((item, index) => {
                ...
                return (
                  <div key={index}>
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm font-medium text-gray-700">{item.category || 'Uncategorized'}</span>
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-gray-500">{formatNumber(item.totalViews || 0)} views</span>
