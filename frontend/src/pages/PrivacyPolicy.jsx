...
const Section = ({ title, children }) => (
  ...
  >
    ...
    <div className="space-y-3 text-base-content/80 leading-relaxed text-sm">
      {children}
    </div>
  </motion.div>
);
...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100">
      {/* Hero */}
      <section className="bg-secondary text-white mt-20 py-20 px-6">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <motion.p
            className="text-base-content/80 leading-relaxed mb-10 text-sm"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
